...
Drive **CarSim 2024** from Claude Code (or any MCP client): edit parameters, run the
...
> ⚠️ **You need your own valid CarSim 2024 and MATLAB licenses.** This project does
...
- **CarSim 2024** (Windows) with a valid license. Start `cslm.exe` first if license-managed.
